...
const Category = () => {
    ...
    const { data, refetch } = useQuery("getCategorys", () =>
    ...
    return (
        <Layout 
            Header={(setVisible,visible)=><Header title="Category" visible={visible} setVisible={setVisible}/>}
        >
            <Modal
                label="Add Category"
                isOpen={isOpen}
            ...
            />
            <div className="w-100">
                <div className="w-100   category-header">
                    <h2>Category</h2>
                ...
                <div className="categories">
                    {
                        data?.map(d => (
                            <Card description={d?.description} id={d?._id} key={d?._id} image={d?.image} name={d?.name} onUpdate={() => {
                                setId(d?._id)
